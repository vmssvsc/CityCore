...
{
    public class PanCityProjectController : BaseController
    {
        public PanCityProjectController(UserManager<ApplicationUser> userManager,
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            _context.ProjectInitiatives.Add(new ProjectInitiative()
                            {
                                ...
                                Title = model.Title,
                                InitiativeType = Enums.InitiativeType.PANCity
                            });
                            _context.SaveChanges();
                            transaction.Commit();
                            return RedirectToAction("PancityCommand");
        ...
        public async Task<ContentResult> GetListI()
        {
            ...
            try
            {
                ...
                finallist = (from ProjectInitiatives in _context.ProjectInitiatives
                             where ProjectInitiatives.InitiativeType == Enums.InitiativeType.PANCity
