InitiativeList = {
    Variables: {
        srcEdit: '/Project/SaveI',
        srcList: '/Project/GetListI',
        srcDelete: '/Project/DeleteI',
        oTable: null,
    },
    Controls: {
        table: '#tblABD',
            ...
            "aoColumnDefs": [
...

                {
                    ...
                    "mRender": function (data, type, full) {
                        return "<a href='/Project/AddEditI?id=" + full[0] + "' ><i class='fa fa-edit'></i></a><a href='javascript:void(0)' onClick=\"\VideoList.DeleteInitiative('" + full[0] + "')\"\><i class='fa fa-trash-o'></i></a>";
                    },
                    "sortable": false,
