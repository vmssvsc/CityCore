InitiativeList = {
    Variables: {
        srcEdit: '/PanCityProject/SaveI',
        srcList: '/PanCityProject/GetListI',
        srcDelete: '/PanCityProject/DeleteI',
        oTable: null,
    },
    Controls: {
        table: '#tblABD',
            ...
            "aoColumnDefs": [
...

                {
                    ...
                    "mRender": function (data, type, full) {
                        return "<a href='/PanCityProject/CommandAddEdit?id=" + full[0] + "' ><i class='fa fa-edit'></i></a><a href='javascript:void(0)' onClick=\"\InitiativeList.DeleteInitiative('" + full[0] + "')\"\><i class='fa fa-trash-o'></i></a>";
                    },
                    "sortable": false,
    ...
    DeleteInitiative: function (id) {
        bootbox.confirm("Are you sure you want to delete this Pan City Command?",
            function (result) {
                if (result) {
                    $.ajax({
                        type: 'get',
